...
class TestSchemaValidator:
    ...
    def test_check_compatibility_safe_type_widening(self):
        ...
        new_schema = {"type": "object", "properties": {"count": {"type": "number"}}}
    ...
    def test_validate_version_compatibility_valid_major_bump(self):
        ...
        is_valid = SchemaValidator.validate_version_compatibility(
            old_version, new_version, has_breaking_changes
        )
...
class TestArrowSchemaValidation:
    ...
    def test_validate_schema_with_arrow_invalid(self):
        ...
        schema_data = {
            ...
            "version": "1.0.0",
            "arrow": {
                "fields": [{"name": "", "type": {"name": "utf8"}}]  # Invalid empty name
            },
        }
